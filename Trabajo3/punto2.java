    ...
    if (e.getSource() == extraer) {
      ...
      try {
        ...
        while (resultado.next()) {
          if (Objects.isNull(resultado.getString("sucursal")) == false) {
        ...
        while (resultado.next()) {
          if (Objects.isNull(resultado.getString("ciudad")) == false) {
        ...
        while (resultado.next()) {
          if (Objects.isNull(resultado.getString("dpto")) == false) {
        ...
        while (resultado.next()) {
          if (Objects.isNull(resultado.getString("pais")) == false) {
        ...
        while (resultado.next()) {
          if (Objects.isNull(resultado.getString("vendedor")) == false) {
            Document document = new Document("codigo", resultado.getString("vendedor"));
            System.out.println(resultado.getString("vendedor"));
            document.append("nombre", resultado.getString("nombre"));
            if (Objects.isNull(resultado.getString("ventas"))) {
              document.append("ventaTotal", 0);
            } else {
        ...
        while (resultado.next()) {
          if (Objects.isNull(resultado.getString("gremio")) == false) {
        ...
        while (resultado.next()) {
          if (Objects.isNull(resultado.getString("producto")) == false) {
        ...
        while (resultado.next()) {
          if (Objects.isNull(resultado.getString("marca")) == false) {
        ...
        JOptionPane.showMessageDialog(null, "Datos cargados a mongo");
